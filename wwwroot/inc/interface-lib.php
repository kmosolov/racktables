...
$image = array();
$image['rackspace']['path'] = 'pix/mainmenu/racks.png';
$image['rackspace']['width'] = 128;
$image['rackspace']['height'] = 128;
$image['objects']['path'] = 'pix/server.png';
$image['objects']['width'] = 128;
$image['objects']['height'] = 128;
$image['depot']['path'] = 'pix/mainmenu/objects.png';
$image['depot']['width'] = 128;
$image['depot']['height'] = 128;
$image['files']['path'] = 'pix/mainmenu/files.png';
$image['files']['width'] = 128;
$image['files']['height'] = 128;
$image['ipv4space']['path'] = 'pix/mainmenu/ipv4.png';
$image['ipv4space']['width'] = 128;
$image['ipv4space']['height'] = 128;
$image['ipv6space']['path'] = 'pix/mainmenu/ipv6.png';
$image['ipv6space']['width'] = 128;
$image['ipv6space']['height'] = 128;
$image['ipv4slb']['path'] = 'pix/mainmenu/slb.png';
$image['ipv4slb']['width'] = 128;
$image['ipv4slb']['height'] = 128;
$image['config']['path'] = 'pix/mainmenu/options.png';
$image['config']['width'] = 128;
$image['config']['height'] = 128;
$image['reports']['path'] = 'pix/mainmenu/reports.png';
$image['reports']['width'] = 128;
$image['reports']['height'] = 128;
$image['8021q']['path'] = 'pix/mainmenu/vlans.png';
$image['8021q']['width'] = 128;
$image['8021q']['height'] = 128;
$image['objectlog']['path'] = 'pix/mainmenu/log.png';
$image['objectlog']['width'] = 128;
$image['objectlog']['height'] = 128;
$image['virtual']['path'] = 'pix/mainmenu/cloud.png';
$image['virtual']['width'] = 128;
$image['virtual']['height'] = 128;
$image['cables']['path'] = 'pix/patch_cables.png';
$image['cables']['width'] = 128;
$image['cables']['height'] = 128;
